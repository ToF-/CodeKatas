# Performance Issue
The breadth-first search algorithm works but it's not efficient. Consider this implementation in Python:
```python
import sys
...
```
When given a list of about 5700 five-letter words, its profiled execution yields the following:
```

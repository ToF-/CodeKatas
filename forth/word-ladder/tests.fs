...
T{
    ...
    S" BOG" S>WORD-KEY ADD-WORD-KEY
    S" GOG" S>WORD-KEY ADD-WORD-KEY
    S" HOG" S>WORD-KEY ADD-WORD-KEY
    S" JOG" S>WORD-KEY ADD-WORD-KEY
    S" LOG" S>WORD-KEY ADD-WORD-KEY
    S" MOG" S>WORD-KEY ADD-WORD-KEY
    S" NOG" S>WORD-KEY ADD-WORD-KEY
    S" ROG" S>WORD-KEY ADD-WORD-KEY
    S" SOG" S>WORD-KEY ADD-WORD-KEY
    S" TOG" S>WORD-KEY ADD-WORD-KEY
    S" VOG" S>WORD-KEY ADD-WORD-KEY
    S" WOG" S>WORD-KEY ADD-WORD-KEY
